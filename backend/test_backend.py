...
Run this to check if the AI engine is properly interconnected.
"""
...
# Add the parent directory to Python path to find backend modules
...
def test_imports():
    ...
    try:
        from backend.config import settings, AGENT_INTERVAL, DEBUG, API_HOST, API_PORT
    ...
    try:
        from backend.logs.logger import log_detection, log_system_event, get_logs
...
async def main():
    """Run all tests."""
    print("🧪 Starting Backend AI Engine Tests")
    print("=" * 50)
